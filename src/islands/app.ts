...
class App {
  private readonly nutritionRecordStore: WritableAtom<NutritionRecord[]> = persistentAtom<NutritionRecord[]>(
    NUTRITION_RECORDS_ID,
    [],
    {
  ...
  public readonly nutritionRecordService: NutritionRecordService = new NutritionRecordServiceImpl(
    this.nutritionRecordStore,
  )
}
